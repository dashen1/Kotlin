...
/**
 * inline extension function {let, with, run, apply, also}
 * apply function returns the incoming object itself.
 * run function  returns the value of the last line of code.
 * */
